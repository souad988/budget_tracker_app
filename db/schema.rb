...
ActiveRecord::Schema[7.0].define(version: 2023_10_23_142255) do
  ...
  create_table "expense_categories", force: :cascade do |t|
    ...
    t.index ["author_id"], name: "index_expense_categories_on_author_id"
  end
  ...
  add_foreign_key "expense_categories", "users", column: "author_id"
